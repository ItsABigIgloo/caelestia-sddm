...
Item {
    ...
    Rectangle {
        ...
        topRightRadius: _radiusS
        bottomRightRadius: _radiusS
        ...
        Row {
            ...
            Text {
                ...
                color: config.text
                font.pixelSize: root.model.length > 0 ? _fontM : _fontS
                font.family: "Rubik"
    ...
    Rectangle {
        ...
        anchors.topMargin: _marg
        anchors.left: labelRect.left
        anchors.leftMargin: -_gap
        width: _ddW
        height: Math.min(_menuMax, root.model.length * (_itemH + _marg))
        clip: true
        z: 999
        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                Text {
                    ...
                    font.family: "Rubik"
                    elide: Text.ElideRight
                    leftPadding: _itemPad
                    rightPadding: _itemPad
