...
Item {
    ...
    SequentialAnimation {
        ...
        PauseAnimation { duration: 300 * speedFactor }
        ...
        ParallelAnimation {
            ...
            SequentialAnimation {
                PauseAnimation { duration: 1100 * speedFactor }
            ...
            SequentialAnimation {
                PauseAnimation { duration: 1250 * speedFactor }
            ...
            SequentialAnimation {
                PauseAnimation { duration: 1400 * speedFactor }
    ...
    SequentialAnimation {
        ...
        PauseAnimation { duration: 2500 * speedFactor }
