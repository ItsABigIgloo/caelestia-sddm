...
Item {
    ...
    property real blurAmount: skipIntroAnimation ? 0 : 1
    property bool skipIntroAnimation
    property real speedFactor: 0.6
    property real star1Opacity: skipIntroAnimation ? 1 : 0
    property real star2Opacity: skipIntroAnimation ? 1 : 0
    property real star3Opacity: skipIntroAnimation ? 1 : 0
    property real star1Scale: skipIntroAnimation ? 1 : 0
    property real star2Scale: skipIntroAnimation ? 1 : 0
    property real star3Scale: skipIntroAnimation ? 1 : 0
    ...
    Item {
        ...
        property color topColour: config.secondary
        property color bottomColour: config.primary

        implicitWidth: designWidth
        implicitHeight: designHeight
        transformOrigin: Item.Center
        scale: root.skipIntroAnimation ? 1 : 0
        opacity: root.skipIntroAnimation ? 1 : 0
        rotation: 0
        layer.enabled: true
        Component.onCompleted: {
            root.star1.opacity = Qt.binding(() => {
                return root.star1Opacity;
            });
            root.star1.scale = Qt.binding(() => {
                return root.star1Scale;
            });
            root.star2.opacity = Qt.binding(() => {
                return root.star2Opacity;
            });
            root.star2.scale = Qt.binding(() => {
                return root.star2Scale;
            });
            root.star3.opacity = Qt.binding(() => {
                return root.star3Opacity;
            });
            root.star3.scale = Qt.binding(() => {
                return root.star3Scale;
            });
        }
