...
Item {
    ...
    function applyStrings(data) {
        ...
        if (data.shutdown !== undefined) config.shutdown = data.shutdown;
        if (data.reboot !== undefined) config.reboot = data.reboot;
        if (data.cancel !== undefined) config.cancel = data.cancel;
        if (data.confirmTitle !== undefined) config.confirmTitle = data.confirmTitle;
        if (data.confirmShutdown !== undefined) config.confirmShutdown = data.confirmShutdown;
        if (data.confirmReboot !== undefined) config.confirmReboot = data.confirmReboot;
        if (data.overlayDarkness !== undefined) config.overlayDarkness = data.overlayDarkness;
        if (data.powerDialogBlur !== undefined) config.powerDialogBlur = data.powerDialogBlur;
        if (data.welcomeMessageLabel !== undefined) config.welcomeMessageLabel = data.welcomeMessageLabel;
        if (data.cardBlurLabel !== undefined) config.cardBlurLabel = data.cardBlurLabel;
        if (data.cardOpacityLabel !== undefined) config.cardOpacityLabel = data.cardOpacityLabel;
        if (data.cardColorOpacityLabel !== undefined) config.cardColorOpacityLabel = data.cardColorOpacityLabel;
        if (data.welcomeBgBlurLabel !== undefined) config.welcomeBgBlurLabel = data.welcomeBgBlurLabel;
        if (data.welcomeColorOpacityLabel !== undefined) config.welcomeColorOpacityLabel = data.welcomeColorOpacityLabel;
        if (data.apLabel !== undefined) config.apLabel = data.apLabel;
        if (data.sessionPickerLabel !== undefined) config.sessionPickerLabel = data.sessionPickerLabel;
        if (data.powerConfirmLabel !== undefined) config.powerConfirmLabel = data.powerConfirmLabel;
        if (data.cardBlurToggleLabel !== undefined) config.cardBlurToggleLabel = data.cardBlurToggleLabel;
        if (data.avatarShapeLabel !== undefined) config.avatarShapeLabel = data.avatarShapeLabel;
        if (data.hexagonLabel !== undefined) config.hexagonLabel = data.hexagonLabel;
        if (data.circleLabel !== undefined) config.circleLabel = data.circleLabel;
    }
