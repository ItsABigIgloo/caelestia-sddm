...
Item {
    ...
    Rectangle {
        ...
        radius: root.radius
        color: mouse.pressed
            ? Qt.rgba(root.rippleColor.r, root.rippleColor.g, root.rippleColor.b, 0.2)
            : mouse.containsMouse
                ? Qt.rgba(root.rippleColor.r, root.rippleColor.g, root.rippleColor.b, 0.15)
                : "transparent"
    }
